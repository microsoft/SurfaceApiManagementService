...
// Surface API Management Service constants
const string SurfaceApiManagementServiceAppId = "76bd8628-ca60-441c-9d83-06503cbfd9c5";
const string SurfaceApiManagementServiceBaseUrl = "https://surface.ams.microsoft.com";
...
request.RequestUri = new Uri($"{SurfaceApiManagementServiceBaseUrl}/api/external/warranty/enrollment");
